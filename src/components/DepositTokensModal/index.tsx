...
export const DepositTokensModal = ({
	...
	return (
		...
		>
			...
			<Subtitle>Add some ETH to launch your token.</Subtitle>
			...
			<HelperContainer>
				This address can only receive ETH on Ethereum mainnet. Do not
				send tokens from other networks or it may result in a loss of
				funds.
			</HelperContainer>
		</ModalSafeForReact18>
	)
